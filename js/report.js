    ...
    $(function () {
        ...
        $('.btn-default').click(function () {
            ...
            if (i % 2 == 0) {
                ...
                myclick();
                $('.addform>span').css({ "background-color": "", "cursor": "pointer" });
            } else {
      ...
      function myclick(){
          $('.addform>span').one('click', function () {
              var text = $(this).text();
              $(this).css({ "background-color": "gray", "cursor":"not-allowed"});
              $.each($('.fixedinfo>b'), function () {
                  var mytext = '<span class="fixedinfo"><input type="checkbox" checked>必填&nbsp;<b>' + text +
                      '</b></span><input type= "text" class="six" > <button class="btn btn-success">delete</button> <br>';
    ...
    $(function(){
        $('#userinfo').on('click', '.btn-success', function () {
            $(this).remove();
            $(this).prev();
